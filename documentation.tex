...
% ----------------------------------------------------------------
\section{Fibre Optic Cable Calculation}
% ----------------------------------------------------------------

\subsection{Backbone Topology}

The four distribution frames are interconnected by OM4 multimode
fibre optic (50/125\,\textmu m) in a \textbf{redundant ring/mesh topology},
...
\subsection{Detailed Fibre Link Calculation}

\begin{table}[H]
  \centering
  \caption{Fibre Optic Backbone Links}
  \label{tab:fo_links}
...
Duplex OM4 cable is used, so both transmit and receive fibres are contained in a
...
Each distribution frame is equipped with one \textbf{PP-72X100G-MMF} fibre patch panel
...
The network uses a \textbf{private address space} under the block \texttt{10.10.0.0/16},
NAT-ed to the public IP address \texttt{109.103.42.124}.
...
\begin{longtable}{C{1cm} L{3.2cm} C{3.2cm} C{2.2cm} C{2cm} C{1.5cm}}
  ...
  \endlastfoot
  \rowcolor{ltblue}
  10  & Management      & 10.10.10.0    & 10.10.10.1   & /25 & 126 \\
  20  & IP\_Phones      & 10.10.20.0    & 10.10.20.1   & /24 & 254 \\
  \rowcolor{rowgray}
  30  & WLAN            & 10.10.32.0    & 10.10.32.1   & /22 & 1{,}022 \\
  100 & HR              & 10.10.100.0   & 10.10.100.1  & /26 & 62 \\
  \rowcolor{rowgray}
  101 & Finance         & 10.10.100.64  & 10.10.100.65 & /26 & 62 \\
  102 & IT\_Ops         & 10.10.100.128 & 10.10.100.129& /26 & 62 \\
  \rowcolor{rowgray}
  103 & Legal           & 10.10.100.192 & 10.10.100.193& /26 & 62 \\
  104 & Sales\_A        & 10.10.101.0   & 10.10.101.1  & /26 & 62 \\
  \rowcolor{rowgray}
  105 & Sales\_B        & 10.10.101.64  & 10.10.101.65 & /26 & 62 \\
  106 & Sales\_C        & 10.10.101.128 & 10.10.101.129& /26 & 62 \\
  \rowcolor{rowgray}
  107 & Sales\_D        & 10.10.101.192 & 10.10.101.193& /26 & 62 \\
  108 & Marketing\_A    & 10.10.102.0   & 10.10.102.1  & /26 & 62 \\
  \rowcolor{rowgray}
  109 & Marketing\_B    & 10.10.102.64  & 10.10.102.65 & /26 & 62 \\
  110 & Frontend\_Dev   & 10.10.102.128 & 10.10.102.129& /26 & 62 \\
  \rowcolor{rowgray}
  111 & Backend\_Dev    & 10.10.102.192 & 10.10.102.193& /26 & 62 \\
  112 & QA\_Test        & 10.10.103.0   & 10.10.103.1  & /26 & 62 \\
  \rowcolor{rowgray}
  113 & Logistics       & 10.10.103.64  & 10.10.103.65 & /26 & 62 \\
  114 & Purchasing      & 10.10.103.128 & 10.10.103.129& /26 & 62 \\
  \rowcolor{rowgray}
  115 & Exec\_Suite     & 10.10.103.192 & 10.10.103.193& /26 & 62 \\
  116 & DevOps\_A       & 10.10.104.0   & 10.10.104.1  & /26 & 62 \\
  \rowcolor{rowgray}
  117 & DevOps\_B       & 10.10.104.64  & 10.10.104.65 & /26 & 62 \\
  118 & SRE\_Internal   & 10.10.104.128 & 10.10.104.129& /26 & 62 \\
  \rowcolor{rowgray}
  119 & Security\_Ops   & 10.10.104.192 & 10.10.104.193& /26 & 62 \\
  120 & Training\_Lab   & 10.10.105.0   & 10.10.105.1  & /26 & 62 \\
  \midrule
  \multicolumn{5}{r}{\textbf{Total usable IP addresses}} & \textbf{2{,}704} \\
\end{longtable}
...
% ----------------------------------------------------------------
\section{Fibre Optic Line Card (min 40\,Gbps ports)}
% ----------------------------------------------------------------
